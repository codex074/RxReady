    ...
    <div className="flex min-h-screen flex-wrap">
      <div className="relative hidden flex-[1_1_380px] flex-col justify-between overflow-hidden bg-[linear-gradient(160deg,#1e63c7,#1746a0)] px-[48px] py-[56px] text-white min-[900px]:flex">
        ...
        <div className="relative max-w-[420px]">
          <div className="mb-[14px] text-[13px] font-semibold tracking-[.18em] text-[#bcd4f7]">USC PHARMACY · ระบบใบค้างยา</div>
          <h1 className="mb-[16px] text-[34px] font-bold leading-[1.25]">ออกใบค้างยา ติดตามสถานะ<br />ตรวจสอบได้ด้วย QR Code</h1>
          <p className="mb-[24px] text-[15px] leading-[1.7] text-[#dbe7fb]">ระบบบริหารจัดการใบค้างยาสำหรับห้องยา ศูนย์การแพทย์เฉพาะทางและตรวจสุขภาพ อุตรดิตถ์ (USC+) ช่วยให้เจ้าหน้าที่ออกใบค้างยาได้รวดเร็ว และผู้ป่วยตรวจสอบสถานะยาได้เองทุกที่</p>
          <div className="flex flex-col gap-[12px]">
            {['ออกใบค้างยาพร้อมเลขที่และ QR อัตโนมัติ', 'อัปเดตสถานะ กำลังเตรียมยา · พร้อมรับ · รับยาแล้ว', 'ผู้ป่วยสแกน QR เพื่อตรวจสอบสถานะได้เอง'].map((text) => (
      ...
      <div className="flex flex-[1_1_440px] items-center justify-center px-[24px] py-[40px]">
        <div className="animate-fade-up w-full max-w-[400px]">
          ...
          <button onClick={onLookup} className="flex w-full cursor-pointer items-center justify-center gap-[8px] rounded-[12px] border border-[#bfdbfe] bg-white p-[13px] text-[14.5px] font-semibold text-[#1d4ed8] transition hover:border-[#93c5fd] hover:bg-[#eff6ff]">ตรวจสอบสถานะยาด้วยเลขใบค้างยา</button>
